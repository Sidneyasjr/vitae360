                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Uma vez que sua conta for deletada, todos os seus recursos e dados também serão permanentemente deletados. Por favor, insira sua
                                senha para confirmar que você gostaria de deletar sua conta permanentemente.
                            </DialogDescription>
                        </DialogHeader>
